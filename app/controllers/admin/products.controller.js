...
router.get('/', mw_auth('web',''), async (req, res) =>{
    ...
    ret_obj.breadcrumbs = [{"text":"Home","link":"/admin/","icon":"bi bi-house"},{"text":"Milestone","link":"#","icon":"bi bi-geo"},];
    ...
    // res.render('admin/entities/product/product_list',{ layout: 'admin/layouts/main_layout',data:ret_obj, products: p_data, p_mil, });
    res.render('admin/entities/product/product_list', { layout: 'admin/layouts/main_layout', data: ret_obj, products: p_data, p_mil });
    
})
router.get('/add_product', mw_auth('web',''), async (req, res) =>{
  let ret_obj = {};
  ret_obj.layout =  mo_layouts.main(req); //Layout Data
  ...
  ret_obj.header = 'Milestones';
  ret_obj.breadcrumbs = [{"text":"Milestones","link":"/admin/milestones/","icon":"bi bi-geo"},{"text":"add_milestones","link":"#","icon":"bi bi-plus-square"},];
  ...
  //res.send(JSON.stringify(req.auth));
  // res.send('Dashboard ' + JSON.stringify(req.auth.status)  );
  res.render('admin/entities/product/add_product',{ layout: 'admin/layouts/main_layout',data:ret_obj, products: p_data, });
...
let p_mil = await h_mysql.execute('SELECT id, milestone, due_date, description FROM milestones',[]);
  ...
  res.render('admin/entities/product/tasks',{ layout: 'admin/layouts/main_layout',data:ret_obj, products: p_data,tasks:p_tasks,p_mil});
